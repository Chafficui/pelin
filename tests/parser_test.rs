...
fn test_parse_string() {
    ...
    let mut parser = Parser::new(tokens);
    let expr = parser.parse().unwrap();
    assert_eq!(expr, Expr::String("Hello, Pelikan!".to_string()));
}
...
fn test_parse_identifier() {
    ...
    let mut parser = Parser::new(tokens);
    let expr = parser.parse().unwrap();
    assert_eq!(expr, Expr::Identifier("variable_name".to_string()));
}
...
fn test_parse_function_definition() {
    ...
    let mut parser = Parser::new(tokens);
    let expr = parser.parse().unwrap();
    assert_eq!(expr, Expr::FunctionDefinition {
...
fn test_parse_return_statement() {
    ...
    let mut parser = Parser::new(tokens);
    let expr = parser.parse().unwrap();
    assert_eq!(expr, Expr::Return(Box::new(Expr::Number(42.0))));
}
